...
import { UserPlus, FileSpreadsheet, AlertCircle, CheckCircle2, ChevronDown, History, Package, ShieldAlert, AlertTriangle } from 'lucide-react';
...
export const Leads: React.FC<LeadsProps> = ({ tenantId }) => {
  ...
  // Decoupled lookup to prevent typing lag
  useEffect(() => {
